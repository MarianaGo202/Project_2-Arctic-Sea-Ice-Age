...
<table align="center">
  ...
  <tr><td>Source file</td><td><code>data/processed/arctic_sea_ice_may_2026.nc</code></td></tr>
...
<table align="center">
  ...
  <tr><td align="center">01</td><td><code>python/import_os.py</code></td><td align="justify">Create the project's folder structure (<code>data/raw</code>, <code>data/processed</code>, <code>database</code>, <code>power bi</code>, <code>python</code>, <code>sql</code>, <code>visualisations</code>) before processing anything</td></tr>
  <tr><td align="center">02</td><td><code>python/ice_analysis.py</code></td><td align="justify">Inspect the NetCDF file, compute sea ice age statistics, aggregate daily means, and export the concentration data for SQL and Power BI</td></tr>
  <tr><td align="center">03</td><td><code>python/create_database.py</code></td><td align="justify">Load the processed concentration data into a SQLite database</td></tr>
  <tr><td align="center">04</td><td><code>sql/ice_analysis.sql</code></td><td align="justify">Query the database — inspect records, compare age categories, rank days by concentration</td></tr>
</table>

**Project setup**

<p align="justify">
Before touching any data, <code>import_os.py</code> creates the full folder structure the rest of the pipeline expects, so the project can be cloned and run from a clean state without manually creating folders first.
</p>
...
<p align="justify">
Before touching the numbers, I inspected <code>arctic_sea_ice_may_2026.nc</code> with <code>xarray</code>: its dimensions, data variables, coordinates, per-variable attributes, and missing-value counts for every variable. This step is what told me the file holds one continuous variable (<code>siage</code>) plus six concentration variables, one per ice age category.
</p>
...
<p align="justify">
I loaded the daily concentration table into SQLite (<code>database/arctic_ice.db</code>) and wrote queries to inspect the table, pull the first records, compare category averages, find the highest and lowest concentration days for 1-year-old ice, rank the top and bottom five days, check the date range and record count, and compute the min/max/average for every age category at once.
</p>
...
<p align="center"><code>power bi/arctic_sea_ice_power_bi_dashboard.pbix</code></p>
...
<table align="center">
  ...
  <tr><td align="center"><code>python/import_os.py</code></td><td align="center">Creates the project's folder structure</td></tr>
  <tr><td align="center"><code>python/ice_analysis.py</code></td><td align="center">Main analysis: NetCDF inspection, sea ice age stats, daily aggregation, CSV export</td></tr>
  <tr><td align="center"><code>python/create_database.py</code></td><td align="center">Loads the processed CSV into the SQLite database</td></tr>
  <tr><td align="center"><code>sql/ice_analysis.sql</code></td><td align="center">SQL queries used to explore the database</td></tr>
  <tr><td align="center"><code>data/processed/arctic_sea_ice_may_2026.nc</code></td><td align="center">Raw NetCDF source file (May 2026)</td></tr>
  <tr><td align="center"><code>data/processed/arctic_sea_ice_sql.csv</code></td><td align="center">Daily concentration by age category, prepared for SQL (31 rows)</td></tr>
  <tr><td align="center"><code>data/processed/powerbi_arctic_sea_ice.csv</code></td><td align="center">Same daily concentration data, exported for Power BI</td></tr>
  <tr><td align="center"><code>database/arctic_ice.db</code></td><td align="center">SQLite database containing the <code>ice_concentration</code> table</td></tr>
  <tr><td align="center"><code>visualisations/daily_mean_ice_age.png</code></td><td align="center">Daily mean Arctic sea ice age visualization</td></tr>
  <tr><td align="center"><code>power bi/arctic_sea_ice_power_bi_dashboard.pbix</code></td><td align="center">Power BI interactive dashboard</td></tr>
</table>
